...
class Settings(BaseSettings):
    ...
    reload: bool = False
    #: Mount prefix when a reverse proxy strips a path prefix before forwarding
    #: (e.g. nginx serving this API under /ai/). Only changes what the OpenAPI
    #: schema and docs UI advertise as the base path -- incoming requests are
    #: already unprefixed by the time they reach this app either way.
    root_path: str = ""
